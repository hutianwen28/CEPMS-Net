...
class PoseRAC(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, factor=0.75, patience=5, verbose=1,
    ...
    def train_dataloader(self):
        ...
        train_loader = DataLoader(dataset, batch_size=64, num_workers=8, shuffle=True)
        return train_loader
